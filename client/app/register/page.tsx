...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex items-center justify-center relative overflow-hidden font-sans selection:bg-[#ea580c]">
      ...
      <div className="absolute bottom-1/4 left-1/4 w-100 h-100 bg-[#0a66c2] rounded-full blur-[180px] opacity-[0.08] pointer-events-none"></div>
      ...
      >
        ...
        <motion.div variants={itemVariants} className="relative group">
          <div className="absolute -inset-0.5 bg-linear-to-r from-[#0a66c2] to-[#ea580c] rounded-3xl blur opacity-30 group-hover:opacity-70 transition duration-1000 group-hover:duration-300"></div>
